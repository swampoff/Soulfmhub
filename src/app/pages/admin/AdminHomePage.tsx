...
export function AdminHomePage() {
  ...
  const streamUrls = [
    { id: 'main', label: 'Main Stream', url: 'https://soul-fm.com/listen', bitrate: '192kbps' },
  ];
          ...
          >
            ...
            <div className="space-y-3">
              <div>
                ...
                <div className="text-sm font-mono bg-white/5 p-2 rounded truncate">soul-fm.com</div>
              </div>
              <div>
                <div className="text-xs text-white/40 mb-1">Port</div>
                <div className="text-sm font-mono bg-white/5 p-2 rounded">443 (HTTPS)</div>
              </div>
              <div>
